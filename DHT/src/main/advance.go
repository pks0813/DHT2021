...
func forceQuitTest() (bool, int, int) {
	_, _ = fmt.Println("Start Force Quit Test")
	...
	for t := 1; t <= forceQuitRoundNum-1; t++ {
		_, _ = fmt.Printf("Force Quit Round %d\n", t)

		/* Force quit. */
		_, _ = fmt.Printf("Start force quitting (round %d)\n", t)
		...
		_, _ = fmt.Printf("Start getting (round %d)\n", t)
...
func quitAndStabilizeTest() (bool, int, int) {
	_, _ = fmt.Println("Start Quit & Stabilize Test")
